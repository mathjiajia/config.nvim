...
_G.packer_plugins = {
  ...
  ["FixCursorHold.nvim"] = {
    loaded = true,
    path = "/Users/jia/.local/share/nvim/site/pack/packer/start/FixCursorHold.nvim",
  ...
  ["heirline.nvim"] = {
    loaded = true,
    path = "/Users/jia/.local/share/nvim/site/pack/packer/start/heirline.nvim",
  ...
  ["nvim-surround"] = {
    ...
    loaded = true,
    path = "/Users/jia/.local/share/nvim/site/pack/packer/start/nvim-surround",
