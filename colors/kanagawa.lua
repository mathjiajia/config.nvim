...
vim.api.nvim_set_hl(0, 'WinSeparator', { fg = tostring(c(colors.bg_dark):lighten(0.6)), bg = colors.bg_dim })
...
vim.api.nvim_set_hl(0, 'Winbar', { fg = colors.fg_dark, bg = 'NONE' })
vim.api.nvim_set_hl(0, 'WinbarNC', { fg = colors.fg_dark, bg = colors.bg_dim })
...
vim.api.nvim_set_hl(0, 'TelescopeResultsClass', { link = '@type' })
vim.api.nvim_set_hl(0, 'TelescopeResultsStruct', { link = '@type' })
vim.api.nvim_set_hl(0, 'TelescopeResultsVariable', { link = '@variable' })
...
-- vim.api.nvim_set_hl(0, '@text.note', { fg = colors.fg_dark, bg = colors.diag.hint, nocombine = true, bold = true })
vim.api.nvim_set_hl(0, '@text.warning', { link = 'Todo' })
vim.api.nvim_set_hl(0, '@text.danger', { link = 'WarningMsg' })
vim.api.nvim_set_hl(0, '@constructor', { fg = colors.kw })
-- vim.api.nvim_set_hl(0, '@conditional', {})
...
vim.api.nvim_set_hl(0, '@exception', { fg = colors.sp3, italic = true })
...
vim.api.nvim_set_hl(0, '@keyword.return', { fg = colors.sp3, italic = true })
...
vim.api.nvim_set_hl(0, '@keyword.operator', { fg = colors.op, bold = true })
...
vim.api.nvim_set_hl(0, '@punctuation.delimiter', { fg = colors.br })
vim.api.nvim_set_hl(0, '@punctuation.bracket', { fg = colors.br })
vim.api.nvim_set_hl(0, '@punctuation.special', { fg = colors.br })
-- vim.api.nvim_set_hl(0, '@repeat', {})
-- vim.api.nvim_set_hl(0, '@string', {})
vim.api.nvim_set_hl(0, '@string.regex', { fg = colors.re })
vim.api.nvim_set_hl(0, '@string.escape', { fg = colors.re, bold = true })
-- vim.api.nvim_set_hl(0, '@symbol', {})
-- vim.api.nvim_set_hl(0, '@type', {})
-- vim.api.nvim_set_hl(0, '@type.builtin', {})
vim.api.nvim_set_hl(0, '@variable', { fg = colors.fg })
vim.api.nvim_set_hl(0, '@variable.builtin', { fg = colors.sp2, italic = true })
...
vim.api.nvim_set_hl(0, '@text.environment', { fg = palette_colors.waveAqua4 }) -- ADDED
vim.api.nvim_set_hl(0, '@text.environment.name', { fg = palette_colors.crystalBlue, italic = true }) -- ADDED
vim.api.nvim_set_hl(0, '@text.math', { fg = palette_colors.sakuraPink }) -- ADDED
