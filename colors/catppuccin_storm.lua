...
vim.api.nvim_set_hl(0, 'CursorLineNr', { fg = cp.diag.warning, bold = true })
-- vim.api.nvim_set_hl(0, 'CursorLineSign', {})
vim.api.nvim_set_hl(0, 'Directory', { fg = cp.sky })
-- vim.api.nvim_set_hl(0, 'EndOfBuffer', {})
vim.api.nvim_set_hl(0, 'ErrorMsg', { fg = cp.diag.error, bold = true, italic = true })
vim.api.nvim_set_hl(0, 'FoldColumn', { fg = cp.gray0, bg = cp.black2 })
vim.api.nvim_set_hl(0, 'Folded', { fg = cp.sky, bg = cp.black4 })
...
vim.api.nvim_set_hl(0, 'PmenuSel', { fg = cp.white, bg = cp.black4 })
...
vim.api.nvim_set_hl(0, 'StatusLine', { fg = cp.black0, bg = cp.blue })
vim.api.nvim_set_hl(0, 'StatusLineNC', { fg = cp.pink, bg = cp.black1 })
vim.api.nvim_set_hl(0, 'Substitute', { fg = cp.white, bg = cp.red })
vim.api.nvim_set_hl(0, 'TabLine', { fg = cp.gray0, bg = cp.black4 })
vim.api.nvim_set_hl(0, 'TabLineFill', { fg = cp.gray0, bg = cp.black2 })
vim.api.nvim_set_hl(0, 'TabLineSel', { fg = cp.white, bg = cp.black3 })
-- vim.api.nvim_set_hl(0, 'TermCursor', {})
-- vim.api.nvim_set_hl(0, 'TermCursorNC', {})
vim.api.nvim_set_hl(0, 'Title', { fg = cp.blue, bold = true })
-- vim.api.nvim_set_hl(0, 'VertSplit', {})
vim.api.nvim_set_hl(0, 'Visual', { bg = cp.black4 })
vim.api.nvim_set_hl(0, 'VisualNOS', { bg = cp.black4, underline = true })
vim.api.nvim_set_hl(0, 'WarningMsg', { fg = cp.black2, bg = cp.red })
vim.api.nvim_set_hl(0, 'Whitespace', { fg = cp.black4 })
vim.api.nvim_set_hl(0, 'WildMenu', { link = 'Pmenu' })
vim.api.nvim_set_hl(0, 'WinSeparator', { fg = cp.gray0 })
...
------ SPELL ------
vim.api.nvim_set_hl(0, 'SpellBad', { undercurl = true, sp = cp.diag.error })
...
vim.api.nvim_set_hl(0, 'DiagnosticUnderlineError', { underdash = true, sp = cp.diag.error })
vim.api.nvim_set_hl(0, 'DiagnosticUnderlineWarn', { underdash = true, sp = cp.diag.warning })
vim.api.nvim_set_hl(0, 'DiagnosticUnderlineInfo', { underdash = true, sp = cp.diag.info })
vim.api.nvim_set_hl(0, 'DiagnosticUnderlineHint', { underdash = true, sp = cp.diag.hint })
...
vim.api.nvim_set_hl(0, 'IndentBlanklineContextChar', { fg = cp.gray })
...
------------ TELESCOPE ----------
vim.api.nvim_set_hl(0, 'TelescopeNormal', { bg = cp.black0 })
vim.api.nvim_set_hl(0, 'TelescopePromptNormal', { fg = cp.white, bg = cp.black1 })

vim.api.nvim_set_hl(0, 'TelescopePromptPrefix', { fg = cp.red, bg = cp.black1 })

vim.api.nvim_set_hl(0, 'TelescopeBorder', { fg = cp.black0, bg = cp.black0 })
vim.api.nvim_set_hl(0, 'TelescopePromptBorder', { fg = cp.black1, bg = cp.black1 })

vim.api.nvim_set_hl(0, 'TelescopePreviewTitle', { fg = cp.black, bg = cp.green })
vim.api.nvim_set_hl(0, 'TelescopePromptTitle', { fg = cp.black, bg = cp.red })
vim.api.nvim_set_hl(0, 'TelescopeResultsTitle', { fg = cp.black0, bg = cp.blue })
...
vim.api.nvim_set_hl(0, 'TSConstMacro', { fg = cp.yellow })
vim.api.nvim_set_hl(0, 'TSConstructor', { fg = cp.lavender })
-- vim.api.nvim_set_hl(0, 'TSDanger', {})
...
-- vim.api.nvim_set_hl(0, 'TSKeywordOperator', {})
vim.api.nvim_set_hl(0, 'TSKeywordReturn', { fg = cp.pink })
-- vim.api.nvim_set_hl(0, 'TSLabel', {})
...
vim.api.nvim_set_hl(0, 'TSNamespace', { fg = cp.rosewater, bold = true })
-- vim.api.nvim_set_hl(0, 'TSNone', {})
vim.api.nvim_set_hl(0, 'TSNote', { fg = cp.black2, bg = cp.blue })
-- vim.api.nvim_set_hl(0, 'TSNumber', {})
-- vim.api.nvim_set_hl(0, 'TSOperator', {})
vim.api.nvim_set_hl(0, 'TSParameter', { fg = cp.rosewater })
vim.api.nvim_set_hl(0, 'TSParameterReference', { fg = cp.white })
vim.api.nvim_set_hl(0, 'TSProperty', { fg = cp.yellow, italic = true })
vim.api.nvim_set_hl(0, 'TSPunctBracket', { fg = cp.maroon, bold = true })
-- vim.api.nvim_set_hl(0, 'TSPunctDelimiter', {})
vim.api.nvim_set_hl(0, 'TSPunctSpecial', { fg = cp.gray1 })
...
vim.api.nvim_set_hl(0, 'TSSymbol', { fg = cp.white })
