...
vim.api.nvim_set_hl(0, 'Cursor', { bg = colors.black, fg = colors.bg })
...
vim.api.nvim_set_hl(0, 'CursorLineNr', { fg = colors.purple, bg = colors.cursorline, bold = true })
...
vim.api.nvim_set_hl(0, 'IncSearch', { bg = colors.selection, fg = colors.yellow })
...
vim.api.nvim_set_hl(0, 'NormalNC', { bg = colors.color_column, fg = colors.fg })
vim.api.nvim_set_hl(0, 'Pmenu', { bg = colors.menu })
vim.api.nvim_set_hl(0, 'PmenuSbar', { bg = colors.menu_scroll })
vim.api.nvim_set_hl(0, 'PmenuSel', { bg = colors.blue, fg = colors.bg })
...
vim.api.nvim_set_hl(0, 'StatusLineNC', { bg = colors.color_column, fg = colors.fg })
vim.api.nvim_set_hl(0, 'Substitute', { bg = colors.yellow, fg = colors.bg })
...
vim.api.nvim_set_hl(0, 'WildMenu', { bg = colors.blue, fg = colors.black })
vim.api.nvim_set_hl(0, 'WinSeperator', { fg = colors.bg })
...
------ NEOTREE ------
vim.api.nvim_set_hl(0, 'NeoTreeNormalNC', { bg = colors.color_column or colors.bg })
...
------ RAINBOW ------
vim.api.nvim_set_hl(0, 'rainbowcol1', { fg = colors.red })
vim.api.nvim_set_hl(0, 'rainbowcol2', { fg = colors.yellow })
vim.api.nvim_set_hl(0, 'rainbowcol3', { fg = colors.orange })
vim.api.nvim_set_hl(0, 'rainbowcol4', { fg = colors.green })
vim.api.nvim_set_hl(0, 'rainbowcol5', { fg = colors.blue })
vim.api.nvim_set_hl(0, 'rainbowcol6', { fg = colors.cyan })
vim.api.nvim_set_hl(0, 'rainbowcol7', { fg = colors.purple })
...
vim.api.nvim_set_hl(0, 'TelescopeSelection', { bg = colors.cursorline, fg = colors.purple })
vim.api.nvim_set_hl(0, 'TelescopeSelectionCaret', { fg = colors.purple })
vim.api.nvim_set_hl(0, 'TelescopeMultiSelection', { bg = colors.cursorline, fg = colors.comment })
...
vim.api.nvim_set_hl(0, 'TSFunction', { fg = colors.blue, italic = true })
vim.api.nvim_set_hl(0, 'TSInclude', { fg = colors.purple, italic = true })
vim.api.nvim_set_hl(0, 'TSKeyword', { fg = colors.purple, italic = true })
vim.api.nvim_set_hl(0, 'TSKeywordFunction', { fg = colors.purple, italic = true })
...
vim.api.nvim_set_hl(0, 'TSString', { fg = colors.green, italic = true })
...
vim.api.nvim_set_hl(0, 'TSVariable', { fg = colors.red, italic = true })
