...
if vim.o.background == 'dark' then
	...
	palette.float_bg     = utils.darken(palette.bg, 0.85)
	...
	palette.float_bg     = utils.darken(palette.bg, 0.95)
...
vim.api.nvim_set_hl(0, 'CursorLineNrNC', { bg = palette.color_column, fg = palette.gray })
...
vim.api.nvim_set_hl(0, 'FoldedNC', { bg = palette.color_column, fg = palette.gray })
vim.api.nvim_set_hl(0, 'FoldColumn', { fg = palette.gray })
vim.api.nvim_set_hl(0, 'SignColumn', { bg = palette.bg })
vim.api.nvim_set_hl(0, 'SignColumnNC', { bg = palette.color_column, fg = palette.gray })
vim.api.nvim_set_hl(0, 'Substitute', { bg = palette.yellow, fg = palette.bg })
vim.api.nvim_set_hl(0, 'LineNr', { fg = palette.gray })
vim.api.nvim_set_hl(0, 'LineNrNC', { bg = palette.color_column, fg = palette.gray })
...
vim.api.nvim_set_hl(0, 'FloatBorder', { bg = palette.float_bg, fg = palette.gray })
vim.api.nvim_set_hl(0, 'Pmenu', { bg = palette.float_bg })
...
vim.api.nvim_set_hl(0, 'Constant', { fg = palette.orange, bold = true })
vim.api.nvim_set_hl(0, 'String', { fg = palette.green, italic = true })
vim.api.nvim_set_hl(0, 'Character', { fg = palette.green })
vim.api.nvim_set_hl(0, 'Number', { fg = palette.orange, bold = true })
...
vim.api.nvim_set_hl(0, 'Type', { fg = palette.yellow, italic = true })
...
vim.api.nvim_set_hl(0, 'TelescopeNormal', { bg = palette.float_bg, fg = palette.fg })
vim.api.nvim_set_hl(0, 'TelescopeBorder', { bg = palette.float_bg, fg = palette.gray })
...
---------- TREESITTER ----------
vim.api.nvim_set_hl(0, '@annotation', { fg = palette.red })
vim.api.nvim_set_hl(0, '@attribute', { fg = palette.purple })
vim.api.nvim_set_hl(0, '@boolean', { link = 'Boolean' })
vim.api.nvim_set_hl(0, '@character', { link = 'Character' })
vim.api.nvim_set_hl(0, '@comment', { link = 'Comment' })
vim.api.nvim_set_hl(0, '@conditional', { fg = palette.purple, italic = true })
vim.api.nvim_set_hl(0, '@constant', { fg = palette.orange, bold = true })
vim.api.nvim_set_hl(0, '@constant.builtin', { fg = palette.purple, bold = true })
vim.api.nvim_set_hl(0, '@constant.macro', { link = '@constant' })
vim.api.nvim_set_hl(0, '@constructor', { fg = palette.yellow })
vim.api.nvim_set_hl(0, '@error', { link = 'Error' })
vim.api.nvim_set_hl(0, '@exception', { link = 'Exception' })
vim.api.nvim_set_hl(0, '@field', { fg = palette.fg })
vim.api.nvim_set_hl(0, '@float', { link = 'Float' })
vim.api.nvim_set_hl(0, '@function', { fg = palette.blue })
vim.api.nvim_set_hl(0, '@function.builtin', { fg = palette.yellow })
vim.api.nvim_set_hl(0, '@function.macro', { fg = palette.blue })
vim.api.nvim_set_hl(0, '@include', { fg = palette.purple, italic = true })
vim.api.nvim_set_hl(0, '@keyword', { fg = palette.purple, italic = true })
vim.api.nvim_set_hl(0, '@keyword.function', { fg = palette.purple })
vim.api.nvim_set_hl(0, '@keyword.operator', { fg = palette.purple, italic = true })
vim.api.nvim_set_hl(0, '@keyword.return', { link = '@keyword' })
vim.api.nvim_set_hl(0, '@label', { fg = palette.purple, italic = true })
vim.api.nvim_set_hl(0, '@method', { fg = palette.blue })
vim.api.nvim_set_hl(0, '@namespace', { fg = palette.yellow })
-- vim.api.nvim_set_hl(0, '@none', {})
vim.api.nvim_set_hl(0, '@number', { fg = palette.orange, bold = true })
vim.api.nvim_set_hl(0, '@operator', { palette.cyan, bold = true })
vim.api.nvim_set_hl(0, '@parameter', { fg = palette.red, italic = true })
vim.api.nvim_set_hl(0, '@parameter.reference', { fg = palette.red })
vim.api.nvim_set_hl(0, '@property', { fg = palette.red })
vim.api.nvim_set_hl(0, '@punctuation.delimiter', { link = 'Delimiter' })
vim.api.nvim_set_hl(0, '@punctuation.bracket', { fg = palette.fg })
vim.api.nvim_set_hl(0, '@punctuation.special', { fg = palette.fg })
vim.api.nvim_set_hl(0, '@repeat', { fg = palette.purple, italic = true })
vim.api.nvim_set_hl(0, '@string', { fg = palette.green })
vim.api.nvim_set_hl(0, '@string.regex', { fg = palette.green, italic = true })
vim.api.nvim_set_hl(0, '@string.escape', { fg = palette.cyan, italic = true })
...
vim.api.nvim_set_hl(0, '@text', { fg = palette.fg })
vim.api.nvim_set_hl(0, '@text.strong', { fg = palette.fg, bold = true })
vim.api.nvim_set_hl(0, '@text.emphasis', { fg = palette.fg, italic = true })
vim.api.nvim_set_hl(0, '@text.underline', { fg = palette.fg, underline = true })
vim.api.nvim_set_hl(0, '@text.strike', { fg = palette.fg })
vim.api.nvim_set_hl(0, '@text.title', { fg = palette.fg })
vim.api.nvim_set_hl(0, '@text.literal', { fg = palette.fg })
vim.api.nvim_set_hl(0, '@text.uri', { fg = palette.blue })
vim.api.nvim_set_hl(0, '@text.math', { fg = palette.red }) -- Modified
...
vim.api.nvim_set_hl(0, '@text.note', { fg = palette.fg })
vim.api.nvim_set_hl(0, '@text.warning', { fg = palette.yellow })
vim.api.nvim_set_hl(0, '@text.danger', { fg = palette.red })
vim.api.nvim_set_hl(0, '@type', { fg = palette.yellow, italic = true })
vim.api.nvim_set_hl(0, '@type.builtin', { fg = palette.yellow, italic = true })
vim.api.nvim_set_hl(0, '@variable', { fg = palette.red })
vim.api.nvim_set_hl(0, '@variable.builtin', { fg = palette.yellow, italic = true })
