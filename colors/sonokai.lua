...
vim.api.nvim_set_hl(0, 'WinSeparator', { fg = cp.grey }) -- the column separating vertically split windows
...
vim.api.nvim_set_hl(0, 'StatusLine', { fg = cp.black, bg = cp.blue })
vim.api.nvim_set_hl(0, 'StatusLineNC', { fg = cp.fg, bg = cp.bg4 })
