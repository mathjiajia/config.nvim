...
---------- TREESITTER ----------
vim.api.nvim_set_hl(0, '@annotation', { fg = cp.purple, italic = true })
vim.api.nvim_set_hl(0, '@attribute', { fg = cp.purple, italic = true })
vim.api.nvim_set_hl(0, '@boolean', { fg = cp.purple })
vim.api.nvim_set_hl(0, '@character', { fg = cp.aqua })
vim.api.nvim_set_hl(0, '@comment', { fg = cp.grey1, italic = true })
vim.api.nvim_set_hl(0, '@conditional', { fg = cp.red })
vim.api.nvim_set_hl(0, '@constant', { fg = cp.fg })
vim.api.nvim_set_hl(0, '@constant.builtin', { fg = cp.blue, italic = true })
vim.api.nvim_set_hl(0, '@constant.macro', { fg = cp.blue, italic = true })
...
vim.api.nvim_set_hl(0, '@keyword.operator', { fg = cp.orange })
-- vim.api.nvim_set_hl(0, '@keyword.return', {})
vim.api.nvim_set_hl(0, '@label', { fg = cp.orange })
-- vim.api.nvim_set_hl(0, '@text.literal', {})
vim.api.nvim_set_hl(0, '@text.math', { fg = cp.blue })
vim.api.nvim_set_hl(0, '@method', { fg = cp.green })
vim.api.nvim_set_hl(0, '@namespace', { fg = cp.yellow, italic = true })
vim.api.nvim_set_hl(0, '@none', { fg = cp.fg })
...
vim.api.nvim_set_hl(0, '@punctuation.bracket', { fg = cp.fg })
vim.api.nvim_set_hl(0, '@punctuation.delimiter', { fg = cp.grey1 })
vim.api.nvim_set_hl(0, '@punctuation.special', { fg = cp.blue })
vim.api.nvim_set_hl(0, '@repeat', { fg = cp.red })
vim.api.nvim_set_hl(0, '@text.strike', { fg = cp.grey1 })
vim.api.nvim_set_hl(0, '@string', { fg = cp.aqua })
...
vim.api.nvim_set_hl(0, '@tag', { fg = cp.orange, italic = true })
-- vim.api.nvim_set_hl(0, '@tag.attribute', { fg = cp.green })
vim.api.nvim_set_hl(0, '@tag.delimiter', { fg = cp.green })
...
vim.api.nvim_set_hl(0, '@variable.builtin', { fg = cp.blue, italic = true })
