...
vim.api.nvim_set_hl(0, 'WinSeparator', { fg = cp.bg5 }) -- the column separating vertically split windows
...
vim.api.nvim_set_hl(0, 'StatusLine', { fg = cp.fg1, bg = cp.bg_statusline3 })
vim.api.nvim_set_hl(0, 'StatusLineNC', { fg = cp.grey1, bg = cp.bg_statusline1 })
vim.api.nvim_set_hl(0, 'TabLine', { fg = cp.bg0, bg = cp.grey2 })
vim.api.nvim_set_hl(0, 'TabLineFill', { fg = cp.fg1, bg = cp.bg0 })
vim.api.nvim_set_hl(0, 'TabLineSel', { fg = cp.fg1, bg = cp.bg_statusline3 })
