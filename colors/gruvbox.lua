...
vim.api.nvim_set_hl(0, '@constructor', { fg = c.aqua })
...
-- vim.api.nvim_set_hl(0, '@text.environment.name', { fg = c.purple }) --
-- vim.api.nvim_set_hl(0, '@error', {})
-- vim.api.nvim_set_hl(0, '@exception', {})
vim.api.nvim_set_hl(0, '@field', { fg = c.aqua })
-- vim.api.nvim_set_hl(0, '@float', {})
-- vim.api.nvim_set_hl(0, '@function.builtin', {})
-- vim.api.nvim_set_hl(0, '@function.macro', {})
-- vim.api.nvim_set_hl(0, '@function', {})
vim.api.nvim_set_hl(0, '@include', { fg = c.blue })
vim.api.nvim_set_hl(0, '@keyword', { fg = c.purple, italic = true })
vim.api.nvim_set_hl(0, '@keyword.function', { fg = c.purple })
vim.api.nvim_set_hl(0, '@label', { fg = c.blue })
-- vim.api.nvim_set_hl(0, '@text.literal', {})
vim.api.nvim_set_hl(0, '@text.math', { fg = c.green }) --
-- vim.api.nvim_set_hl(0, '@method', {})
vim.api.nvim_set_hl(0, '@namespace', { fg = c.red })
-- vim.api.nvim_set_hl(0, '@none', {})
vim.api.nvim_set_hl(0, '@text.note', { fg = c.bg, bg = c.info })
-- vim.api.nvim_set_hl(0, '@number', {})
vim.api.nvim_set_hl(0, '@operator', { fg = util.darken(c.orange, 0.85) })
vim.api.nvim_set_hl(0, '@parameter', { fg = c.red })
-- vim.api.nvim_set_hl(0, '@parameter.reference', {})
vim.api.nvim_set_hl(0, '@property', { fg = c.red })
vim.api.nvim_set_hl(0, '@punctuation.bracket', { fg = util.darken(c.orange, 0.85) })
vim.api.nvim_set_hl(0, '@punctuation.delimiter', { fg = c.red })
vim.api.nvim_set_hl(0, '@punctuation.special', { fg = util.darken(c.orange, 0.85) })
-- vim.api.nvim_set_hl(0, '@repeat', {})
-- vim.api.nvim_set_hl(0, '@text.strike', {})
-- vim.api.nvim_set_hl(0, '@string', {})
vim.api.nvim_set_hl(0, '@string.escape', { fg = c.red })
vim.api.nvim_set_hl(0, '@string.regex', { fg = c.orange })
...
vim.api.nvim_set_hl(0, '@variable.builtin', { fg = c.aqua })
