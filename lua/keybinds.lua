...
-- Telescope
nmap('<leader><space>', function() require('telescope.builtin').buffers() end, { silent = true, desc = 'Buffers' })
nmap('<leader>fd', function() require('telescope.builtin').grep_string() end, { silent = true, desc = 'Grep Strings' })
nmap('<leader>ff', function()
	require('telescope.builtin').find_files { hidden = true }
end, { silent = true, desc = 'Find Files' })
nmap('<leader>fg', function() require('telescope.builtin').live_grep() end, { silent = true, desc = 'Live Grep' })
nmap('<leader>fh', function() require('telescope.builtin').help_tags() end, { silent = true, desc = 'Help Tags' })
nmap('<leader>fk', function() require('telescope.builtin').keymaps() end, { silent = true, desc = 'Keymaps' })
nmap('<leader>fl', function() require('telescope.builtin').highlights() end, { desc = 'Highlight Groups' })
nmap('<leader>fo', function() require('telescope.builtin').oldfiles() end, { silent = true, desc = 'Old Files' })
nmap('<leader>fs', function()
	require('telescope.builtin').current_buffer_fuzzy_find()
end, { silent = true, desc = 'Current Buffer Fuzzy Find' })
nmap('<leader>ft', function() require('telescope.builtin').tags() end, { silent = true, desc = 'Tags' })
