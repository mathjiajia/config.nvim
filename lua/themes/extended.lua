...
vim.api.nvim_set_hl(0, 'StatusLineNC', { fg = yellow, bg = statusline_bg })
...
-- vim.api.nvim_set_hl(0, 'TSNone', {}) -- Don't change the values of this highlight group.
...
vim.api.nvim_set_hl(0, 'TSStrong', { fg = baby_pink, bold = true })
...
-- vim.api.nvim_set_hl(0, 'IndentBlanklineContextStart', { underdash = true })
...
vim.api.nvim_set_hl(0, 'rainbowcol7', { fg = vibrant_green })
