...
local function apply_base16_theme(theme)
	...
	vim.api.nvim_set_hl(0, 'Conceal', { fg = theme.base04, bg = theme.base00 })
	...
	vim.api.nvim_set_hl(0, 'MatchParen', { bg = theme.base03 })
	...
	-- vim.api.nvim_set_hl(0, 'StatusLine', { fg = theme.base04, bg = 'NONE' })
	-- vim.api.nvim_set_hl(0, 'StatusLineNC', { fg = theme.base03, bg = 'NONE' })
	...
	-- vim.api.nvim_set_hl(0, 'Underlined', { fg = theme.base08 })
	...
	vim.api.nvim_set_hl(0, 'Boolean', { fg = theme.base09, italic = true })
	...
	vim.api.nvim_set_hl(0, 'Marco', { fg = theme.base08 })
	vim.api.nvim_set_hl(0, 'Number', { fg = theme.base09 })
	vim.api.nvim_set_hl(0, 'Operator', { fg = theme.base05, bold = true })
