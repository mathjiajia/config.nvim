...
M = {
	...
	s({ trig = 'lll', wordTrig = false, name = 'ell' }, { t('\\ell') }, { condition = vimtex.in_mathzone }),
	...
	s({ trig = 'AA', wordTrig = false, name = 'affine' }, { t('\\mathbb{A}') }, { condition = vimtex.in_mathzone }),
	s({ trig = 'CC', wordTrig = false, name = 'complex' }, { t('\\mathbb{C}') }, { condition = vimtex.in_mathzone }),
	s({ trig = 'DD', wordTrig = false, name = 'disc' }, { t('\\mathbb{D}') }, { condition = vimtex.in_mathzone }),
	s({ trig = 'FF', wordTrig = false, name = 'Hirzebruch' }, { t('\\mathbb{F}') }, { condition = vimtex.in_mathzone }),
	s({ trig = 'HH', wordTrig = false, name = 'half plane' }, { t('\\mathbb{H}') }, { condition = vimtex.in_mathzone }),
	s({ trig = 'NN', wordTrig = false, name = 'natural' }, { t('\\mathbb{N}') }, { condition = vimtex.in_mathzone }),
	s({ trig = 'OO', wordTrig = false, name = 'mathcal{O}' }, { t('\\mathcal{O}') }, { condition = vimtex.in_mathzone }),
	s({ trig = 'PP', wordTrig = false, name = 'projective' }, { t('\\mathbb{P}') }, { condition = vimtex.in_mathzone }),
	s({ trig = 'QQ', wordTrig = false, name = 'rational' }, { t('\\mathbb{Q}') }, { condition = vimtex.in_mathzone }),
	s({ trig = 'RR', wordTrig = false, name = 'real' }, { t('\\mathbb{R}') }, { condition = vimtex.in_mathzone }),
	s({ trig = 'ZZ', wordTrig = false, name = 'integer' }, { t('\\mathbb{Z}') }, { condition = vimtex.in_mathzone }),
	s(
