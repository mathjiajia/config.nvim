...
autosnips = {
	...
	s({ trig = 'lll', wordTrig = false, name = 'ell ℓ' }, { t '\\ell' }, { condition = context.in_mathzone }),
	s({ trig = 'xx', wordTrig = false, name = 'times ×' }, { t '\\times' }, { condition = context.in_mathzone }),
	s({ trig = 'nabl', wordTrig = false, name = 'nabla ∇' }, { t '\\nabla' }, { condition = context.in_mathzone }),
	s({ trig = 'AA', wordTrig = false, name = 'affine 𝔸' }, { t '\\mathbb{A}' }, { condition = context.in_mathzone }),
	s({ trig = 'CC', wordTrig = false, name = 'complex ℂ' }, { t '\\mathbb{C}' }, { condition = context.in_mathzone }),
	s({ trig = 'DD', wordTrig = false, name = 'disc 𝔻' }, { t '\\mathbb{D}' }, { condition = context.in_mathzone }),
	s(
		{ trig = 'FF', wordTrig = false, name = 'Hirzebruch 𝔽' },
		{ t '\\mathbb{F}' },
		{ condition = context.in_mathzone }
	),
	s({ trig = 'GG', wordTrig = false, name = 'algebraic group 𝔾' }, { t '\\mathbb{G}' },
		{ condition = context.in_mathzone }),
	s(
	...
	s({ trig = 'NN', wordTrig = false, name = 'natural ℕ' }, { t '\\mathbb{N}' }, { condition = context.in_mathzone }),
	s({ trig = 'OO', wordTrig = false, name = 'mathcal{O}' }, { t '\\mathcal{O}' }, { condition = context.in_mathzone }),
	s(
	...
	s({ trig = 'RR', wordTrig = false, name = 'real ℝ' }, { t '\\mathbb{R}' }, { condition = context.in_mathzone }),
	s({ trig = 'ZZ', wordTrig = false, name = 'integer ℤ' }, { t '\\mathbb{Z}' }, { condition = context.in_mathzone }),
	s(
		{ trig = 'srt', wordTrig = false, name = 'square root' },
		{ t '\\sqrt{', i(1), t '}' },
		{ condition = context.in_mathzone }
	),
	s({ trig = 'set', name = 'set' }, { t '\\{', i(1), t '\\}' }, { condition = context.in_mathzone }),
	s({ trig = 'o+', wordTrig = false, name = 'oplus' }, { t '\\oplus ' }, { condition = context.in_mathzone }),
	s({ trig = 'ox', wordTrig = false, name = 'otimes' }, { t '\\otimes' }, { condition = context.in_mathzone }),
	s({ trig = 'cap', wordTrig = false, name = 'cap' }, { t '\\cap ' }, { condition = context.in_mathzone }),
	s({ trig = 'cup', wordTrig = false, name = 'cup' }, { t '\\cup ' }, { condition = context.in_mathzone }),
	s({ trig = 'nnn', wordTrig = false, name = 'bigcup' }, { t '\\bigcap ' }, { condition = context.in_mathzone }),
	s({ trig = 'uuu', wordTrig = false, name = 'bigcap' }, { t '\\bigcup ' }, { condition = context.in_mathzone }),
	s({ trig = 'sub', name = 'subseteq ⊆', wordTrig = false }, { t '\\subseteq ' }, { condition = context.in_mathzone }),
	-- s({ trig = 'sup', name = 'supseteq ⊇', wordTrig = false }, { t '\\supseteq' }, { condition = context.in_mathzone }),

	-- s({ trig = '<|', name = 'triangleleft <|', wordTrig = false }, { t '\\triangleleft ' }, { condition = context.in_mathzone }),
	-- s({ trig = '|>', name = 'triangleright |>', wordTrig = false }, { t '\\triangleright ' }, { condition = context.in_mathzone }),

	s({ trig = 'MK', name = 'Mori-Kleiman cone' }, { t '\\cNE(', i(1), t ')' }, { condition = context.in_mathzone }),
	s(
	...
	s({ trig = ';0', name = 'emptyset ∅', wordTrig = false }, { t '\\emptyset' }, { condition = context.in_mathzone }),
	s({ trig = ';6', name = 'partial ∂', wordTrig = false }, { t '\\partial' }, { condition = context.in_mathzone }),
	s({ trig = ';8', name = 'infinity ∞', wordTrig = false }, { t '\\infty' }, { condition = context.in_mathzone }),
	s({ trig = ';=', name = 'equiv ≡', wordTrig = false }, { t '\\equiv ' }, { condition = context.in_mathzone }),
	s({ trig = ';-', name = 'setminus \\', wordTrig = false }, { t '\\setminus ' }, { condition = context.in_mathzone }),
	s({ trig = ';.', name = 'emptyset ∅', wordTrig = false }, { t '\\cdot' }, { condition = context.in_mathzone }),
	s({ trig = ';A', name = 'forall ∀', wordTrig = false }, { t '\\forall' }, { condition = context.in_mathzone }),
	s({ trig = ';E', name = 'exists ∃', wordTrig = false }, { t '\\exists' }, { condition = context.in_mathzone }),
	-- s({ trig = 'xmm', wordTrig = false, name = 'x_m' }, { t('x_{m}') }, { condition = context.in_mathzone }),
	-- s({ trig = 'xnn', wordTrig = false, name = 'x_n' }, { t('x_{n}') }, { condition = context.in_mathzone }),
	-- s({ trig = 'ymm', wordTrig = false, name = 'y_m' }, { t('y_{m}') }, { condition = context.in_mathzone }),
	-- s({ trig = 'ynn', wordTrig = false, name = 'y_n' }, { t('y_{n}') }, { condition = context.in_mathzone }),
}
